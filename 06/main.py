...
# Вероятно, вы расплачивались за проезд и получали билет с номером. Счастливым билетом называют такой
...
if a < 100000 or a > 999999: print("Ввели не шестизначное число!")
else:
